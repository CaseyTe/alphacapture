...
var require_microphone_stream = __commonJS({
  "node_modules/microphone-stream/dist/microphone-stream.js"(exports) {
    ...
    var buffer_from_1 = __importDefault(require_buffer_from());
    var MicrophoneStream = (
      /** @class */
      function(_super) {
        __extends(MicrophoneStream2, _super);
        function MicrophoneStream2(opts) {
          if (opts === void 0) {
        ...
        MicrophoneStream2.prototype.setStream = function(stream) {
          var _this = this;
          this.stream = stream;
        ...
        MicrophoneStream2.prototype.pauseRecording = function() {
          this.recording = false;
        };
        MicrophoneStream2.prototype.playRecording = function() {
          this.recording = true;
        };
        MicrophoneStream2.prototype.stop = function() {
        ...
        MicrophoneStream2.prototype._read = function() {
        };
        MicrophoneStream2.toRaw = function(chunk) {
...
export default require_microphone_stream();
/*! Bundled license information:

safe-buffer/index.js:
  (*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> *)
*/
//# sourceMappingURL=microphone-stream.js.map
